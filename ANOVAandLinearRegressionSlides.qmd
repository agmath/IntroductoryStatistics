...
vii) Calculate the $p$-value using the $F$ distribution with `df1` as "one less than the number of groups" and `df2` as "the number of observations minus the number of groups"
