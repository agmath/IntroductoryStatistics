...
a) Payton uses a critical value of $z^* = 1.96$ and gets an interval of $\left(3.908, 4.692\right)$.
b) Charlie uses a critical value of $t^* = 2.03$ and gets an interval of $\left(3.894, 4.706$\right)$.
