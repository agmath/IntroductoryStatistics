...
iv. Critical Value: `qt(1 - 0.01, df = 34)` $\approx$ `r round(qt(1 - 0.01, df = 34), 2)`
...
iv. Critical Value: `qt(1 - 0.01, df = 34)` $\approx$ `r round(qt(1 - 0.01, df = 34), 2)`
v. $\displaystyle{S_E = \sqrt{\frac{s_1^2}{n_1} + \frac{s_2^2}{n_2}}}$
...
iv. Critical Value: `qt(1 - 0.01, df = 34)` $\approx$ `r round(qt(1 - 0.01, df = 34), 2)`
v. $\displaystyle{S_E = \sqrt{\frac{2^2}{40} + \frac{2.5^2}{35}}}$
...
iv. Critical Value: `qt(1 - 0.01, df = 34)` $\approx$ `r round(qt(1 - 0.01, df = 34), 2)`
v. $\displaystyle{S_E \approx 0.5278}$
