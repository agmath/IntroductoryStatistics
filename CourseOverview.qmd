...
:::{.nonincremental}
  ...
  + Embedded Tutor: Audrey Saidel
    ...
    + Drop-in Location: PL Hall, Room 104
    + Drop-in Hours (Please Visit!): Wednesdays from 2:15 - 5:30pm
...
First and foremost...everything is free!
  ...
  + **Software:** We'll make use of the R computing language and RStudio. You've hopefully already installed all of these items, but [instructions for doing so are here](https://agmath.github.io/IntroductoryStatistics/InstallingSoftware.html).
  + **Optional MyOpenMath Supplements:** I wrote a course shell for use with the OpenIntro Statistics textbook at [MyOpenMath](https://www.myopenmath.com/). This course shell includes optional (ungraded) practice assignments and practice exams.
...
+ **Interactive Notebooks:** Completing these on time is crucial, as they'll be the way you are exposed to material and practice with it.
  ...
  + You'll generate *hash codes* at the end of each notebook and submit that hash code using a Google Form (see BrightSpace for the link)
+ **Exams:** We'll have two exams during the semester -- each one will have three parts.
  ...
  + **Individual Exam (75% or 65%):** Similar to the group exam, but you're on your own this time.  
...
We'll use this time to get your software up and running. This is a two-step process, [documented with links here](https://agmath.github.io/IntroductoryStatistics/InstallingSoftware.html). A general description of the steps appears below.
...
For those of you already set up, [follow this link](https://agmath.github.io/WebRtutorials/MAT241_Intro.html) and start playing with R in your web browser. See if you can do the following:

1. Read the data by running the code chunk below the **Let's get started!** heading.
2. Skip over the `Wafflehouse` section and see if you can change the fill color in the metal bands and happiness plot to your favorite color!
3. Change the plot labels.
:::
