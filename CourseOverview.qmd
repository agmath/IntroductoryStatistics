...
We'll use this time to get your software up and running. This is a two-step process, [documented with links here](https://agmath.github.io/IntroductoryStatistics/InstallingSoftware.html). A general description of the steps appears below. I'll skip to the Exit Ticket slide so that people with complete setups can finish that and take back some of their time.
