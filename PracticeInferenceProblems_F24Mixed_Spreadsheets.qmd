...
You may benefit by referring back to the [General Strategy for Constructing Confidence Intervals](http://agmath.github.io/SiteFiles/CIgeneral_Excel.pdf){target="_blank"}, [General Strategy for Conducting Hypothesis Tests](http://agmath.github.io/SiteFiles/HTgeneral_Excel.pdf){target="_blank"}, and [Standard Error Decision Tree](http://agmath.github.io/SiteFiles/StdErrorDecisionTree.pdf){target="_blank"} documents.

:::{.callout-note}
## On Chi-Squared Tests

Depending on the semester, we may not have covered the mechanics of these tests. You should, however, be able to identify scenarios that call for a Chi-Squared *Goodness of Fit* test or a test for *Independence* because this requires only your knowledge of variable types. In those cases, simply identify the appropriate test and move on.
:::
