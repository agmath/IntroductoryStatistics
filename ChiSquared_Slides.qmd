...
ii) Measure the probability of observing a sample at least as extreme as ours in that reality (this is called the $p$-value)
    ...
    + If our observed data is "unlikely" ($p$-value is lower than the *level of significance*, $\alpha$), then what  we've observed is **incompatible** with our assumed reality; we declare that the null hypothesis is false and accept the alternative hypothesis instead
