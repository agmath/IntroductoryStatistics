...
i) Assume the claim is false, in reality (*null hypothesis*)
ii) Measure the probability of observing a sample at least as extreme as ours in that reality (this is called the $p$-value)
...
1. What are the hypotheses to test the researcher's question of interest?
2. Verify that the test statistic for the test is $4$ and the $p$-value is approximately $0.261$.
3. Use the $p$-value to determine the appropriate conclusion for the test. Be sure to provide your interpretation in the context of the scenario.
