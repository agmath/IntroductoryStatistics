...
**PROBLEM -- The Notebooks Have Disappeared:** This problem has randomly impacted a few of my students recently (Fall 2024). The fix is to reinstall the notebooks by running each of the following, one at a time, in the console.
