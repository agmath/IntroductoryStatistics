...
*Note.* Today's discussion is listed as `18. Software Output / Numerical Inference Lab`
...
**Task:** A 95% confidence interval was built for the difference in average home heating costs for homes using oil and homes using natural gas. The interval was constructed for $\mu_{\text{oil}} - \mu_{\text{gas}}$ and resulted in the bounds -\$117.43 and \$213.87. Interpret the results of the interval in context and describe the implications for individuals deciding on a home heating method conversion.
