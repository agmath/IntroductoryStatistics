...
## Review of R Functionality for the Normal Distribution
...
The probability that $X$ takes on a value *less than* (or *less than or equal to*) $k$ is $\mathbb{P}\left[X < k\right] \approx$ `pbinom(k, mean = mu, sd = sigma)`
