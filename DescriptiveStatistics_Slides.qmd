...
**Task:** The variable measuring the number of bedrooms is one that we said we could treat as either numerical or categorical. It is also reasonable to expect that the number of bedrooms would vary by home type. Describe what descriptive statistics you might investigate to examine whether the number of bedrooms is associated with the home type.
