...
$\bigstar$ Open our `Day2to5_AustinHousingData.qmd` file and find the answers to several of the questions we asked last time. While our questions from last class were all about *averages* try using some of the other functions to gain deeper understanding of our numeric variables.
...
We can use `na.rm = TRUE` as an argument to our summary functions to *remove missing values from the calculation*
