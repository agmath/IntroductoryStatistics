...
Navigate down to line `55` of the Quarto document. There, you'll note that we're going to fill in a *data dictionary* for the Zillow Dataset (or your preferred alternative).
...
3. **Homework:** Complete and submit the `Topic 2` notebook at least 30 minutes before our next class meeting. This notebook will give you a first introduction to using R.
