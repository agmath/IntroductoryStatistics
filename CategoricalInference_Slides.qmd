...
That blue dashed line is at the underlying population proportion (`r pop_prop`)
...
**Scenario:** A fast food chain wants to estimate the proportion of fast-food-eaters who prefer its chicken sandwich over its competitors'. A random sample of 300 fast-food enthusiasts shows that 65% prefer the chain's sandwich. Construct a 90% confidence interval for the true proportion of customers who prefer the sandwich. Interpret the interval in context.
...
**Scenario:** A local survey of 800 randomly selected households in a city finds that 68% of them recycle. Construct and interpret a 90% confidence interval for the true proportion of recyclers in the city. A city's environmental department is running an initiative to raise recycling rates to at least 65% -- what, if any, insight does your confidence interval give into the success of this initiative?

## Examples to Try: Return Rates for an Online Store

**Scenario:** An online store needs to estimate the return rate for products purchased by customers.The store conducts an audit, randomly selecting 225 transactions and finds that 6.5% of the customers returned items. Construct and interpret a 95% confidence interval for the true return rate.

## Examples to Try: Video Game Console Popularity

**Scenario:** A gaming company has developed a new controller design. A limited release to a random sample of 93 gamers reveals that about 79.6% prefer the new controller design. Construct and interpret a 98% confidence interval for the true proportion of gamers who prefer the new controller design. The company has decided that, if at least 75% of video game players prefer this new controller design, they'll mass produce and sell it. Does your confidence interval suggest that the company should produce and sell the controllers?

## Examples to Try: Support for a New Environmental Policy

**Scenario:** A politician claims that a minority of the public supports a new environmental policy. A random sample of 627 people finds that 54% of them support the policy. At the 10% significance level, can you reject the politician's claim?
...
*Note.* Today's discussion is listed as `10. Introduction to Inference`
...
**Task:** A researcher wants to know whether a new fertilizer increases average crop yield, and by how much, compared to the standard fertilizer. Would a confidence interval or a hypothesis test better answer their question? Justify your answer, and describe what information the other approach would fail to provide.
